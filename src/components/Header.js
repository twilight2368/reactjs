          ...
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
                      ...
                      <NavLink
                        ...
                        className={
                            ({isActive}) => {
                                 ...
                                 return 'rounded-md px-3 py-2 font-medium no-underline text-1xl '
                                        + ( isActive ?
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <button
                  type="button"
                  className="rounded-full bg-yellow-400 p-1 text-black hover:text-white"
                >
              ...
              {navigation.map((item) => (
                ...
                className={
                    ({isActive}) => {
                         ...
                         return 'rounded-md px-3 py-2 font-medium no-underline text-1xl w-full '
                                + ( isActive ?
                                   'bg-yellow-400 text-red-600  hover:text-red-600' :
                                      ' hover:bg-yellow-400 hover:text-red-600 text-white');
                    }
